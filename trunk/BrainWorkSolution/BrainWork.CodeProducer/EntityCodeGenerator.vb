...
Partial Public Class EntityCodeGenerator
    ...
    Private ReadOnly Property GetBLTemplate() As String
        Get
            Dim strTemplate As String = vbCrLf & "Public Class ____blClassName____                                                                            "
            ...
            strTemplate += vbCrLf & "        Me.CurrentEntity = New ____entClassName____                                                         "
            ...
            strTemplate += vbCrLf & "                                                                                                            "
            strTemplate += vbCrLf & "    Public Overrides Property EntityObject() As Object                                                      "
            strTemplate += vbCrLf & "        Get                                                                                                 "
            strTemplate += vbCrLf & "            Return Me.CurrentEntity                                                                         "
            strTemplate += vbCrLf & "        End Get                                                                                             "
            strTemplate += vbCrLf & "        Set(ByVal value As Object)                                                                          "
            ...
            strTemplate += vbCrLf & "            End If                                                                                          "
            strTemplate += vbCrLf & "            Me.CurrentEntity = value                                                                        "
            strTemplate += vbCrLf & "        End Set                                                                                             "
            strTemplate += vbCrLf & "    End Property                                                                                            "
