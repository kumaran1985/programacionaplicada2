...
Namespace JavaScript
    Public Class JavaScriptUtils
        ...
        Shared Sub JS_ToolTip(ByVal objPagina As Page, ByVal t As Type)
            Dim sb As New System.Text.StringBuilder()
            sb.AppendLine("<div id=""dhtmltooltip""></div>                                                                                                                                         ")
            sb.AppendLine("                                                                                                                                                                        ")
            sb.AppendLine("<script type=""text/javascript"">                                                                                                                                       ")
            sb.AppendLine("                                                                                                                                                                        ")
            sb.AppendLine("/***********************************************                                                                                                                        ")
            sb.AppendLine("* Cool DHTML tooltip script- © Dynamic Drive DHTML code library (www.dynamicdrive.com)                                                                                  ")
            sb.AppendLine("* This notice MUST stay intact for legal use                                                                                                                            ")
            sb.AppendLine("* Visit Dynamic Drive at http://www.dynamicdrive.com/ for full source code                                                                                              ")
            sb.AppendLine("***********************************************/                                                                                                                        ")
            sb.AppendLine("                                                                                                                                                                        ")
            sb.AppendLine("var offsetxpoint=-60 //Customize x offset of tooltip                                                                                                                    ")
            sb.AppendLine("var offsetypoint=20 //Customize y offset of tooltip                                                                                                                     ")
            sb.AppendLine("var ie=document.all                                                                                                                                                     ")
            sb.AppendLine("var ns6=document.getElementById && !document.all                                                                                                                        ")
            sb.AppendLine("var enabletip=false                                                                                                                                                     ")
            sb.AppendLine("if (ie||ns6)                                                                                                                                                            ")
            sb.AppendLine("var tipobj=document.all? document.all[""dhtmltooltip""] : document.getElementById? document.getElementById(""dhtmltooltip"") : """"                                     ")
            sb.AppendLine("                                                                                                                                                                        ")
            sb.AppendLine("function ietruebody(){                                                                                                                                                  ")
            sb.AppendLine("return (document.compatMode && document.compatMode!=""BackCompat"")? document.documentElement : document.body                                                           ")
            sb.AppendLine("}                                                                                                                                                                       ")
            sb.AppendLine("                                                                                                                                                                        ")
            sb.AppendLine("function ddrivetip(thetext, thecolor, thewidth){                                                                                                                        ")
            sb.AppendLine("if (ns6||ie){                                                                                                                                                           ")
            sb.AppendLine("if (typeof thewidth!=""undefined"") tipobj.style.width=thewidth+""px""                                                                                                  ")
            sb.AppendLine("if (typeof thecolor!=""undefined"" && thecolor!="""") tipobj.style.backgroundColor=thecolor                                                                             ")
            sb.AppendLine("tipobj.innerHTML=thetext                                                                                                                                                ")
            sb.AppendLine("enabletip=true                                                                                                                                                          ")
            sb.AppendLine("return false                                                                                                                                                            ")
            sb.AppendLine("}                                                                                                                                                                       ")
            sb.AppendLine("}                                                                                                                                                                       ")
            sb.AppendLine("                                                                                                                                                                        ")
            sb.AppendLine("function positiontip(e){                                                                                                                                                ")
            sb.AppendLine("if (enabletip){                                                                                                                                                         ")
            sb.AppendLine("var curX=(ns6)?e.pageX : event.clientX+ietruebody().scrollLeft;                                                                                                         ")
            sb.AppendLine("var curY=(ns6)?e.pageY : event.clientY+ietruebody().scrollTop;                                                                                                          ")
            sb.AppendLine("//Find out how close the mouse is to the corner of the window                                                                                                           ")
            sb.AppendLine("var rightedge=ie&&!window.opera? ietruebody().clientWidth-event.clientX-offsetxpoint : window.innerWidth-e.clientX-offsetxpoint-20                                      ")
            sb.AppendLine("var bottomedge=ie&&!window.opera? ietruebody().clientHeight-event.clientY-offsetypoint : window.innerHeight-e.clientY-offsetypoint-20                                   ")
            sb.AppendLine("                                                                                                                                                                        ")
            sb.AppendLine("var leftedge=(offsetxpoint<0)? offsetxpoint*(-1) : -1000                                                                                                                ")
            sb.AppendLine("                                                                                                                                                                        ")
            sb.AppendLine("//if the horizontal distance isn't enough to accomodate the width of the context menu                                                                                   ")
            sb.AppendLine("if (rightedge<tipobj.offsetWidth)                                                                                                                                       ")
            sb.AppendLine("//move the horizontal position of the menu to the left by it's width                                                                                                    ")
            sb.AppendLine("tipobj.style.left=ie? ietruebody().scrollLeft+event.clientX-tipobj.offsetWidth+""px"" : window.pageXOffset+e.clientX-tipobj.offsetWidth+""px""                          ")
            sb.AppendLine("else if (curX<leftedge)                                                                                                                                                 ")
            sb.AppendLine("tipobj.style.left=""5px""                                                                                                                                               ")
            sb.AppendLine("else                                                                                                                                                                    ")
            sb.AppendLine("//position the horizontal position of the menu where the mouse is positioned                                                                                            ")
            sb.AppendLine("tipobj.style.left=curX+offsetxpoint+""px""                                                                                                                              ")
            sb.AppendLine("                                                                                                                                                                        ")
            sb.AppendLine("//same concept with the vertical position                                                                                                                               ")
            sb.AppendLine("if (bottomedge<tipobj.offsetHeight)                                                                                                                                     ")
            sb.AppendLine("tipobj.style.top=ie? ietruebody().scrollTop+event.clientY-tipobj.offsetHeight-offsetypoint+""px"" : window.pageYOffset+e.clientY-tipobj.offsetHeight-offsetypoint+""px""")
            sb.AppendLine("else                                                                                                                                                                    ")
            sb.AppendLine("tipobj.style.top=curY+offsetypoint+""px""                                                                                                                               ")
            sb.AppendLine("tipobj.style.visibility=""visible""                                                                                                                                     ")
            sb.AppendLine("}                                                                                                                                                                       ")
            sb.AppendLine("}                                                                                                                                                                       ")
            sb.AppendLine("                                                                                                                                                                        ")
            sb.AppendLine("function hideddrivetip(){                                                                                                                                               ")
            sb.AppendLine("if (ns6||ie){                                                                                                                                                           ")
            sb.AppendLine("enabletip=false                                                                                                                                                         ")
            sb.AppendLine("tipobj.style.visibility=""hidden""                                                                                                                                      ")
            sb.AppendLine("tipobj.style.left=""-1000px""                                                                                                                                           ")
            sb.AppendLine("tipobj.style.backgroundColor=''                                                                                                                                         ")
            sb.AppendLine("tipobj.style.width=''                                                                                                                                                   ")
            sb.AppendLine("}                                                                                                                                                                       ")
            sb.AppendLine("}                                                                                                                                                                       ")
            sb.AppendLine("                                                                                                                                                                        ")
            sb.AppendLine("document.onmousemove=positiontip                                                                                                                                        ")
            sb.AppendLine("                                                                                                                                                                        ")
            sb.AppendLine("</script>                                                                                                                                                               ")

            If Not objPagina.ClientScript.IsStartupScriptRegistered("BrainWork_ToolTip") Then
                objPagina.ClientScript.RegisterStartupScript(t, "BrainWork_ToolTip", sb.ToString(), False)
            End If
